...
class P2pChat(tk.Frame):
    ...
    def createWidgets(self):
        ...
        menu.add_command(label="Change user name", command=self.prompt_new_name)
        menu.add_separator()
        ...
        port_max_len = 5
        port_entry = tk.Entry(port_frame, width=port_max_len, validate='key', vcmd=vcmd)
        port_entry.pack(side=tk.LEFT)
        port_entry.insert(0, DEFAULT_PORT)
        self.port_entry = port_entry

        # Host Instruction Label
        self.host_instr_label = tk.Label(ip_port_frame, text="<-- Tell your friend this ip and port")
